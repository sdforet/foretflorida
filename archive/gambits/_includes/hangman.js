...
//table for picture and in game nav and info
      + "<table width='95%' height='390' border='0' align='center' bgcolor='#000000' cellpadding='15'>"
         + "<tr><td id='hang_pic' rowspan='6' ><img src='_images/gate/gate1.png' width='390' height='390' align='middle'/></td></tr>"
         + "<tr><td><h3 class='centerContentT' ><a href='javascript:generate_word()' ><span id='SGmenu'>Start the Gate!</span></a></h3></td></tr>"
         + "<tr><td id='start_link'><h2 class='centerContentSG'><a href='javascript:guess_letter()' ><span id='SGmenu'>Guess a Letter</span></a></h2></td></tr>"
         + "<tr><td id='hint_link'><h2 class='centerContentSG'><a href='javascript:hint_letter()' ><span id='SGmenu'>Hint</span></a></h2></td></tr>"
         + "<tr><td id='hint_text'><p class='centerContentSG'>&nbsp;</p></td></tr>"
         + "<tr><td id='letter_holder' class ='used_letters'>" + USED_L + "</td></tr>"
      + "</tr></table>"
//table for word letters
         ...
         + "<tr id='word_row' colspan='2'>"
            ...
            + "<td></td>"
            + "<td><h3 class='centerContentT'><a href='javascript:resetAll()' >Reset all!</a></h3></td>"
         + "</tr></table>"
      + "<br />"
      + "<br />"
      + "<p id='testline'>Test Line</p>"
      );
 }
...
function guess_letter ()
{
 ...
 function generate_word()
 {
   ...
   document.getElementById("hint_text").innerHTML  = ("Your Word has " + WORD.length + " letters in it.");
    ...
    if (WRONG_G == 9)
      {
         ...
         TEST_C = 0;}
    if (TEST_C == 1){document.getElementById("testline").innerHTML = ("<p id='testline'>Test Line from check_win(): var WRONG_G = "+ WRONG_G +", var WORD = "+ WORD + " , var CORRECT_G = "+ CORRECT_G +"</p>");}
 }
